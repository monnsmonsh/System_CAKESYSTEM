...
ALTER TABLE Clientes ADD FOREIGN KEY (idEstado) REFERENCES estados (idEstado);


-- Estructura de tabla para la tabla `municipios`
CREATE TABLE municipios (
  idMunicipios int identity primary key not null,
...
-- Filtros para la tabla `Clientes`
ALTER TABLE municipios ADD FOREIGN KEY (idEstado) REFERENCES estados (idEstado);
ALTER TABLE Clientes ADD FOREIGN KEY (idMunicipios) REFERENCES municipios (idMunicipios);
...
INSERT INTO municipios (idEstado, clave, nombre, sigla) VALUES
(1, '001', 'Aguascalientes', ''),
(1, '002', 'Asientos', ''),
(1, '003', 'Calvillo', ''),
(1, '004', 'Cosío', ''),
(1, '005', 'Jesús María', ''),
(1, '006', 'Pabellón de Arteaga', ''),
(1, '007', 'Rincón de Romos', ''),
(1, '008', 'San José de Gracia', ''),
(1, '009', 'Tepezalá', ''),
(1, '010', 'El Llano', ''),
(1, '011', 'San Francisco de los Romo', ''),
(2, '001', 'Ensenada', ''),
(2, '002', 'Mexicali', ''),
(2, '003', 'Tecate', ''),
(2, '004', 'Tijuana', ''),
(2, '005', 'Playas de Rosarito', ''),
(3, '001', 'Comondú', ''),
(3, '002', 'Mulegé', ''),
(3, '003', 'La Paz', ''),
(3, '008', 'Los Cabos', ''),
...
(5, '005', 'Candela', ''),
(5, '006', 'Castaños', ''),
(5, '007', 'Cuatro Ciénegas', ''),
(5, '008', 'Escobedo', ''),
(5, '009', 'Francisco I. Madero', ''),
(5, '010', 'Frontera', ''),
(5, '011', 'General Cepeda', ''),
(5, '012', 'Guerrero', ''),
(5, '013', 'Hidalgo', ''),
(5, '014', 'Jiménez', ''),
(5, '015', 'Juárez', ''),
...
(5, '023', 'Ocampo', ''),
(5, '024', 'Parras', ''),
(5, '025', 'Piedras Negras', ''),
(5, '026', 'Progreso', ''),
(5, '027', 'Ramos Arizpe', ''),
(5, '028', 'Sabinas', ''),
(5, '029', 'Sacramento', ''),
(5, '030', 'Saltillo', ''),
(5, '031', 'San Buenaventura', ''),
(5, '032', 'San Juan de Sabinas', ''),
(5, '033', 'San Pedro', ''),
(5, '034', 'Sierra Mojada', ''),
(5, '035', 'Torreón', ''),
(5, '036', 'Viesca', ''),
...
(6, '008', 'Minatitlán', ''),
(6, '009', 'Tecomán', ''),
(6, '010', 'Villa de Álvarez', ''),
(7, '001', 'Acacoyagua', ''),
(7, '002', 'Acala', ''),
(7, '003', 'Acapetahua', ''),
(7, '004', 'Altamirano', ''),
(7, '005', 'Amatán', ''),
(7, '006', 'Amatenango de la Frontera', ''),
(7, '007', 'Amatenango del Valle', ''),
(7, '008', 'Angel Albino Corzo', ''),
(7, '009', 'Arriaga', ''),
(7, '010', 'Bejucal de Ocampo', ''),
(7, '011', 'Bella Vista', ''),
(7, '012', 'Berriozábal', ''),
(7, '013', 'Bochil', ''),
(7, '014', 'El Bosque', ''),
...
(7, '025', 'Chapultenango', ''),
(7, '026', 'Chenalhó', ''),
(7, '027', 'Chiapa de Corzo', ''),
(7, '028', 'Chiapilla', ''),
(7, '029', 'Chicoasén', ''),
(7, '030', 'Chicomuselo', ''),
(7, '031', 'Chilón', ''),
(7, '032', 'Escuintla', ''),
(7, '033', 'Francisco León', ''),
(7, '034', 'Frontera Comalapa', ''),
(7, '035', 'Frontera Hidalgo', ''),
(7, '036', 'La Grandeza', ''),
(7, '037', 'Huehuetán', ''),
(7, '038', 'Huixtán', ''),
(7, '039', 'Huitiupán', ''),
(7, '040', 'Huixtla', ''),
(7, '041', 'La Independencia', ''),
(7, '042', 'Ixhuatán', ''),
(7, '043', 'Ixtacomitán', ''),
(7, '044', 'Ixtapa', ''),
(7, '045', 'Ixtapangajoya', ''),
...
(7, '050', 'La Libertad', ''),
(7, '051', 'Mapastepec', ''),
(7, '052', 'Las Margaritas', ''),
(7, '053', 'Mazapa de Madero', ''),
(7, '054', 'Mazatán', ''),
(7, '055', 'Metapa', ''),
(7, '056', 'Mitontic', ''),
(7, '057', 'Motozintla', ''),
...
(7, '059', 'Ocosingo', ''),
(7, '060', 'Ocotepec', ''),
(7, '061', 'Ocozocoautla de Espinosa', ''),
(7, '062', 'Ostuacán', ''),
(7, '063', 'Osumacinta', ''),
(7, '064', 'Oxchuc', ''),
(7, '065', 'Palenque', ''),
...
(7, '069', 'Pijijiapan', ''),
(7, '070', 'El Porvenir', ''),
(7, '071', 'Villa Comaltitlán', ''),
(7, '072', 'Pueblo Nuevo Solistahuacán', ''),
(7, '073', 'Rayón', ''),
(7, '074', 'Reforma', ''),
(7, '075', 'Las Rosas', ''),
(7, '076', 'Sabanilla', ''),
(7, '077', 'Salto de Agua', ''),
(7, '078', 'San Cristóbal de las Casas', ''),
(7, '079', 'San Fernando', ''),
(7, '080', 'Siltepec', ''),
(7, '081', 'Simojovel', ''),
(7, '082', 'Sitalá', ''),
...
(7, '113', 'Aldama', ''),
(7, '114', 'Benemérito de las Américas', ''),
(7, '115', 'Maravilla Tenejapa', ''),
(7, '116', 'Marqués de Comillas', ''),
(7, '117', 'Montecristo de Guerrero', ''),
(7, '118', 'San Andrés Duraznal', ''),
(7, '119', 'Santiago el Pinar', ''),
(8, '001', 'Ahumada', ''),
(8, '002', 'Aldama', ''),
(8, '003', 'Allende', ''),
(8, '004', 'Aquiles Serdán', ''),
(8, '005', 'Ascensión', ''),
(8, '006', 'Bachíniva', ''),
(8, '007', 'Balleza', ''),
(8, '008', 'Batopilas', ''),
...
(8, '027', 'Guachochi', ''),
(8, '028', 'Guadalupe', ''),
(8, '029', 'Guadalupe y Calvo', ''),
(8, '030', 'Guazapares', ''),
(8, '031', 'Guerrero', ''),
(8, '032', 'Hidalgo del Parral', ''),
(8, '033', 'Huejotitán', ''),
(8, '034', 'Ignacio Zaragoza', ''),
(8, '035', 'Janos', ''),
(8, '036', 'Jiménez', ''),
(8, '037', 'Juárez', ''),
(8, '038', 'Julimes', ''),
...
(8, '048', 'Namiquipa', ''),
(8, '049', 'Nonoava', ''),
(8, '050', 'Nuevo Casas Grandes', ''),
(8, '051', 'Ocampo', ''),
(8, '052', 'Ojinaga', ''),
(8, '053', 'Praxedis G. Guerrero', ''),
(8, '054', 'Riva Palacio', ''),
(8, '055', 'Rosales', ''),
(8, '056', 'Rosario', ''),
(8, '057', 'San Francisco de Borja', ''),
(8, '058', 'San Francisco de Conchos', ''),
(8, '059', 'San Francisco del Oro', ''),
(8, '060', 'Santa Bárbara', ''),
(8, '061', 'Satevó', ''),
(8, '062', 'Saucillo', ''),
(8, '063', 'Temósachic', ''),
...
(12, '079', 'José Joaquín de Herrera', ''),
(12, '080', 'Juchitán', ''),
(12, '081', 'Iliatenco', ''),
(13, '001', 'Acatlán', ''),
(13, '002', 'Acaxochitlán', ''),
...
(19, '013', 'China', ''),
(19, '014', 'Doctor Arroyo', ''),
(19, '015', 'Doctor Coss', ''),
(19, '016', 'Doctor González', ''),
(19, '017', 'Galeana', ''),
(19, '018', 'García', ''),
(19, '019', 'San Pedro Garza García', ''),
(19, '020', 'General Bravo', ''),
(19, '021', 'General Escobedo', ''),
(19, '022', 'General Terán', ''),
(19, '023', 'General Treviño', ''),
(19, '024', 'General Zaragoza', ''),
(19, '025', 'General Zuazua', ''),
(19, '026', 'Guadalupe', ''),
(19, '027', 'Los Herreras', ''),
(19, '028', 'Higueras', ''),
(19, '029', 'Hualahuises', ''),
...
(20, '549', 'Heroica Villa Tezoatlán de Segura y Luna', ''),
